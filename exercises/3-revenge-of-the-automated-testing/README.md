...
2. Navigate to your instance of Jenkins at `https://jenkins-<YOUR_NAME>-ci-cd.apps.<OpenShift cluster url>`.
...
```bash
export E2E_TEST_ROUTE=todolist-fe-<YOUR_NAME>-dev.apps.<OpenShift cluster url>
npm install
npm run e2e:ci
```
